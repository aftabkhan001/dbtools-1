...
parser.add_argument('--where', dest='where', required=True,  type=str,
                   help='where condition')

parser.add_argument('--limit', dest='limit', type=int,
                   help='batch size, (default: %(default)s)', default=100)

parser.add_argument('--root-table', dest='root_table', required=True , type=str,
                   help='root table  name')
